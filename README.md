...
Como Testar
==========
Como o IDE apresentado em sala foi o IntelliJ, será explicado como testar o funcionamento do jogo nele. Após clonar este
repositório e depois do IntelliJ terminar de configurar o Gradle, é necessário ir na barra superior, e trocar o Run de
Current File para Client. Após isso, basta iniciar o Client (Shift + F10), criar um mundo teste e interagir com o HUD
do mod.
